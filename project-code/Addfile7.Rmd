---
title: "Additional file 7 -  Supplementary table and plot of the minor allele frequency distribution"
author:
date:
output:
...
\renewcommand{\thefigure}{S7.\arabic{figure}}
\renewcommand{\tablename}{Table}
\renewcommand{\thetable}{S7.\arabic{table}}
