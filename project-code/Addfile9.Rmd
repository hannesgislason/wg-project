---
title: "Additional file 9 -  Supplementary tables and figures of _ROH_ with McQuillan2008 _ROH_ parameters: --homozyg --homozyg-snp 25 --homozyg-kb hkb --homozyg-gap 100 for minimum _ROH_ $> 500$kb."
author:
date:
output:
...
\renewcommand{\thefigure}{S9.\arabic{figure}}
\renewcommand{\tablename}{Table}
\renewcommand{\thetable}{S9.\arabic{table}}
...
rohreport_name <- "rohreportAddfile9.csv"
...
```{r, fig.width = 7, fig.asp = 0.85, out.width="80%", fig.align="center", fig.cap = "Plots of the number of runs of homozygosity NROH ($NSEQ$) against the total length of runs SROH ($KB/1000$) in the PLINK report for the minimum lengths of $ROH>0.4$Mb. At about $1.0$Mb the points are maximum shifted to the right from the diagonal."}
